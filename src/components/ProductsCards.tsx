...
// const ProductsCards:React.FC = (props) => {
//   return (
...
//         variant="top"
//         src={props.thumbnail}
//         style={{ height: "195px", width: "229px" }}
//       /> */}
//       <Card.Body>
//         <Card.Title style={{ overflow: "hidden" }}>{props.title}</Card.Title>
//         <Card.Text
//           style={{ fontWeight: 700, fontSize: "12px" }}
//         >{`$${props.price}`}</Card.Text>
//         <RatingReview rating={props.rating} />
//       </Card.Body>
//     </Card>
//   );
// };
